...
public class EditBoardPopup : MonoBehaviour
{
	...
	private void SetEditMode()
	{
		...
		_challengesToValidateText.text = $"1/{_gameData.challenges.Count} Desaf�os";
	...
	private void SetCreateMode()
	{
		...
		_challengesToValidateText.text = $"0/{_gameData.challenges.Count} Desaf�os Corregidos y Validados";
	...
	private void SliderUpdated(float value)
	{
		...
		_challengesCountText.text = "Desaf�os: " + _gameData.challengesCount;
	...
	private async Task RerollImage()
	{
		...
		// string prompt = "Crea una imagen que represente un juego de tablero con este t�tulo: " + _tittleInput.text + ". El/Los protagonistas de la imagen es/son patitos de goma amarillos.";
	...
	private void ValidateQuestion()
	{
		...
		else
		{
			...
			_questionsToValidateText.text = "Validaci�n Completada!";
		}
	...
	private void ValidateChallenge()
	{
		...
		else
		{
			...
			_challengesToValidateText.text = "Validaci�n Completada!";
	...
	private void LoadChallenge(string challenge, int i)
	{
		...
		if (GameController.GameState == GameStateState.Editing)
			_challengesToValidateText.text = $"{_currentChallengeIndex}/{_gameData.challenges.Count} Desaf�os";
	}
	...
	private void RefreshValidations()
	{
			...
			_challengesToValidateText.text = $"{_validatedChallengesCount}/{_gameData.challenges.Count} Desaf�os Corregidos y Validados";		
