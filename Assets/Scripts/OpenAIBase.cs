...
public abstract class OpenAIBase
{
	...
	public class GPT4Mini : OpenAIBase
	{
		...
		{
			string jsonData = $"{{\"model\": \"gpt-4o-mini\", \"messages\": [{{\"role\": \"user\", \"content\": \"{prompt}\"}}]}}";
	...
	{
		private const string _apiKey = "sk - proj - uw2T8Q65jOWWKm_M5GaCNMVWN1rBZxbK - 4eG0QMvVXFVtrm7FLh576G9-FT3BlbkFJrOISNsK1DABMIDBeZfgvt3qtWTOzcx-eoicLAtsfnvs7zAbMjdStq75ewA";
		...
		public async void GetGPTResponse(string prompt)
		{
